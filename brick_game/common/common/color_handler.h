/**
 * @file common_color_handler.h
 * @brief This file contains color definitions and color handling functions for
 * the brick game.
 */
...
/**
 * @brief Array of color pairs for block rendering.
 */
static const int BLOCK_COLOR_PAIRS_ARRAY[] = {
...
/**
 * @brief Initialize the game colors and color pairs.
 */
void initGameColors();
